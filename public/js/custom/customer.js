$(document).ready(function() {
    ...
    $(document).on('click', '#saveCustomer', function() {
        ...
        if (!$('input[name="compName"]').val() || !$('input[name="poc"]').val() || $('select[name="type"]').val() == 0 || $('select[name="country"]').val() == 0 || !$('input[name="businessPh"]').val() || !$('input[name="address"]').val() || !$('input[name="city"]').val() || $('select[name="documentTypes"]').val() == 0 || $('select[name="deliveryPorts"]').val() == 0) {
            $('#notifDiv').fadeIn();
