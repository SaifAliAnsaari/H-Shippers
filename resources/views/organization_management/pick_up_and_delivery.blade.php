...
<div id="product-cl-sec">
    ...
    <div class="pc-cartlist">
        <form style="display: flex; width:100%" id="savePickUpForm">
    ...
    <div class="_cl-bottom">
        <button type="submit" class="btn btn-primary mr-2" id="savePickUp">Save</button>
        <button type="submit" class="btn btn-primary mr-2" id="updatePickUp" style = "display:none;">Update</button>
        <button id="pl-close" type="submit" class="btn btn-cancel mr-2" id="cancelPickUp">Cancel</button>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a class="btn add_button openDataSidebarForAddingCompany"><i class="fa fa-plus"></i> Add Pick up & Delivery Location</a>
