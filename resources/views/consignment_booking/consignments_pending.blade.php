                            ...
                            @foreach($consignments as $consignmnet)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-default process_hard_btn" data-toggle="modal" data-target="#processModal" name="{{ $consignmnet['opp'] }}" id="{{ $consignmnet['consignment_id'] }}">Received</button>
