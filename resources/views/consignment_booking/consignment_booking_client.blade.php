    ...
    <div class="col-md-12 sm-pb-30">
        <div class="row">
            ...
            <div class="_new-consign-top">
                ...
                <input type="text" id="cnic_client" name="cnic_client" value="{{ $cnno }}" readonly
                    class="form-control required" placeholder="" style="font-size: 13px">
            </div>
            <div class="_new-consign-top">
                <label class="control-label label3">Customer ID:</label>
                <input type="text" name="customer_id_client" value="<?= $client_id ?>" readonly id="customer_id_client"
            ...
            <div class="_new-consign-top mr-0">
                ...
                <input type="text" name="region_client" id="region_client" class="form-control" placeholder="Lahore"
                    style="font-size: 13px">
            </div>
        </div>
    </div>
