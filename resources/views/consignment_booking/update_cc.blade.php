    ...
    <div class="col-md-12 sm-pb-30">
        <div class="row">
            ...
            <div class="_new-consign-top">
                ...
                <div class="form-group">
                    <div class="input-append date position-relative" id="dp3" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
                        <input type="text" value="12-02-2012" readonly name="datepicker" id="update_datepicker" style="font-size: 13px">
            ...
            <div class="_new-consign-top">
                ...
                <input type="text" name="customer_id_client" value="00" readonly id="update_customer_id_client" class="form-control"
                    placeholder="Lhr02154" style="font-size: 13px">
            </div>

            <div class="_new-consign-top mr-0">
                <label class="control-label label4">Region*:</label>
                <input type="text" name="region_client" id="update_region_client" class="form-control required" placeholder="Lahore"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="consignee_name_client" id="consignee_name_client" class="form-control required"
                                    placeholder="" style="font-size: 13px">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="consignee_ref_client" id="consignee_ref_client" class="form-control required"
                                    placeholder="" style="font-size: 13px">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="consignee_cell_client" id="consignee_cell_client" class="form-control required"
                                    placeholder="" style="font-size: 13px">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="email" name="consignee_email_client" id="consignee_email_client" class="form-control required"
                                    placeholder="" style="font-size: 13px">
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="consignee_address_client" id="consignee_address_client" class="form-control required"
                                    placeholder="" style="font-size: 13px">
                            </div>
                        </div>
                ...
                <div class="form-wrap pt-0 PB-20">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-s2 pt-19">
                                <div>
                                    <select class="form-control formselect required" placeholder="Services Type" name="consignment_service_type_client"
                                        id="consignment_service_type_client">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="consignment_description_client" id="consignment_description_client"
                                    class="form-control required" placeholder="" style="font-size: 13px">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-s2 pt-19">
                                <div>
                                    <select class="form-control formselect required" placeholder="Services Type" name="consignment_dest_city_client"
                                        id="consignment_dest_city_client">
                            ...
                            <div class="col-md-12">
                                <div class="row mb-10">
                                    <div class="custom-control custom-radio col-md-3 col-xs-3">
                                        <input class="custom-control-input insurance_selector" type="radio" name="Fragile_Criteria"
                                            id="Fragile" value='For Fragile' data-id="Fragile">
                                        <label class="custom-control-label" for="Fragile">For Fragile</label>
                                    </div>

                                    <div class="custom-control custom-radio col-md-3 col-xs-3">
                                        <input class="custom-control-input insurance_selector" type="radio" name="Fragile_Criteria"
                                            id="Non-Fragile" value='For Non Fragile' data-id="Non-Fragile">
                                        <label class="custom-control-label" for="Non-Fragile">For Non Fragile</label>
                                    </div>

                                    <div class="custom-control custom-radio col-md-3 col-xs-3">
                                        <input class="custom-control-input insurance_selector" type="radio" name="Fragile_Criteria"
                                            id="Electronics" value='For Electronics' data-id="Electronics">
                                        <label class="custom-control-label" for="Electronics">For Electronics</label>
                                    </div>

                                    <div class="custom-control custom-radio col-md-3 col-xs-3">
                                        <input class="custom-control-input insurance_selector" type="radio" name="Fragile_Criteria"
                                            id="none" value='none' data-id="none">
                ...
                <div class="row _checkbox-padd">
                    ...
                    <div class="col-md-3 col-xs-3">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input supplementary_services_client" value="Holiday"
                                id="id001">
                    ...
                    <div class="col-md-3 col-xs-3">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input supplementary_services_client" value="Special Handling"
                                id="id002">
                    ...
                    <div class="col-md-3 col-xs-3">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input supplementary_services_client" value="Time Specified"
                                id="id003">
                    ...
                    <div class="col-md-3 col-xs-3">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input supplementary_services_client" value="Passport"
                                id="id004">
