...
<form id="saveAccessRights">
    ...
    <div class="row" style="margin-top:30px;" id="access_rights_div" style="">

        <div class="col-lg-6 col-md-6 col-sm-6">
            <h2 class="_head01">Select <span> Rights</span></h2>
        </div>
    ...
    <div class="row">
        <button style="position:relative; margin-left:10px; top:25px;" type="button" class="btn btn-primary mr-2 save_rights">Save</button>
    </div>
</form>
